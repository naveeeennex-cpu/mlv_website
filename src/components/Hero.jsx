          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6 text-center py-20">
            ...
            >
              ...
              <p className="text-white/70 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
                We provide high-quality smart locks and security solutions that are
                     trusted by homes, apartments, and commercial projects across Tamil Nadu.
              </p>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-2">
                ...
                <span className="text-white text-xs font-medium">Yale Authorised Dealer</span>
              </div>
              <div className="pt-4">
                <a
                  href="#booking"
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div>
            <p className="text-light-muted text-sm leading-relaxed">
              MLV Enterprises is a professional company and Yale Authorised Dealer that focuses on the supply and installation of smart locks for homes and commercial 
              projects. Our main products include premium smart door locks, wardrobe 
              locks, video door phones, smart surveillance systems, and smart video 
              doorbells — all installed by trained technicians with full after-sales 
              support.
            </p>
          </div>
        </div>
