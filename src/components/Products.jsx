...
const SHOWCASE_PRODUCTS = [
  ...
  },
  {
    ...
    highlight: '',
    description:
      'Secure your valuables with our modern digital safes. Featuring biometric access, tamper alarms, and fire-resistant options.',
    image: 'https://gw-assets.assaabloy.com/is/image/assaabloy/Smart%20Safe%20Main_1080x1080_6-4',
    dark: false,
    link: '/products#fire-safes',
  },
  {
    name: 'Smart Automation',
    highlight: '',
    description:
      'Experience the next level of convenience with our upcoming smart home automation systems. Seamlessly integrate all your security devices.',
    image: 'https://dmnwhfs1e7dfi.cloudfront.net/media/assets/images/lock-essential-black/esential-black-3.webp',
    dark: true,
    link: '/products#automation-coming-soon',
  },
];
    ...
    <div className={product.dark ? 'bg-dark' : 'bg-white'}>
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 items-center min-h-[500px]">
          ...
          >
            <Link to={product.link || '/products'} className="block">
              <img
                src={product.image}
                alt={product.name}
                className="w-full max-w-xl lg:max-w-2xl h-auto max-h-[450px] object-contain hover:scale-105 transition-transform duration-500"
                loading="lazy"
              />
            </Link>
          </motion.div>
