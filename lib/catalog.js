...
// Budget bands (₹). max is exclusive; the last band is open-ended.
export const BUDGET_BANDS = [
  { id: 'bud:1', label: '₹5,000 – ₹12,000',  min: 5000,  max: 12000 },
  { id: 'bud:2', label: '₹12,000 – ₹25,000', min: 12000, max: 25000 },
  { id: 'bud:3', label: '₹25,000 – ₹45,000', min: 25000, max: 45000 },
  { id: 'bud:4', label: '₹45,000 & above',   min: 45000, max: null },
];
...
export async function searchCompatible(material, config, budget = null, limit = 10) {
  const db = getDb();
  const params = [JSON.stringify([material]), DOOR_LOCK_CATEGORIES];
